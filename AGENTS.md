...
repository — edit it directly. The general rules below started as a copy of the
shared `common-agent-config` instructions; repository-specific rules follow
under "Repository Guidelines".
...
`README.md`, `docs/**`, and `AGENTS.md` (this file) are hand-written — edit them
directly.
