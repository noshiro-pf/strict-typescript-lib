...
```sh
npm install -D https://github.com/noshiro-pf/strict-typescript-lib/releases/download/dist-v5.0-0.4.0/strict-ts-lib-v5.0-branded-0.4.0.tgz
```
...
```jsonc
{
    "compilerOptions": {
        ...
        "paths": {
            "@typescript/lib-*": [
                "./node_modules/strict-ts-lib-v5.0-branded/libs/*",
            ],
        },
    },
}
