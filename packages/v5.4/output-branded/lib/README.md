...
```sh
npm install -D https://github.com/noshiro-pf/strict-typescript-lib/releases/download/dist-v5.4-0.3.0/strict-ts-lib-v5.4-branded-0.3.0.tgz
```
...
```jsonc
{
    "compilerOptions": {
        ...
        "paths": {
            "@typescript/lib-*": [
                "./node_modules/strict-ts-lib-v5.4-branded/libs/*",
            ],
        },
    },
}
