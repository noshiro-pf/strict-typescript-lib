...
```sh
npm install -D https://github.com/noshiro-pf/strict-typescript-lib/releases/download/dist-v6.0-0.1.0/strict-ts-lib-v6.0-branded-0.1.0.tgz
```
...
```jsonc
{
    "compilerOptions": {
        ...
        "paths": {
            "@typescript/lib-*": [
                "./node_modules/strict-ts-lib-v6.0-branded/libs/*",
            ],
        },
    },
}
